...
public static class IEnumerableExtension
{
    private static void Example()
    {
        ...
        testIenumerable.ForEach(number => {});
        ...
        testList.ForEachReverse(number => {});
    ...
    public static T GetValueWithType<T>(this Dictionary<string, object> instance, string name)
    {
        object value;
        bool ok = instance.TryGetValue(name, out value);
        if (ok)
        {
            return (T) value;
        }
